...
vertex_model_batch = tf.compat.v1.data.make_one_shot_iterator(vertex_model_dataset).get_next()
...
face_model_batch = tf.compat.v1.data.make_one_shot_iterator(face_model_dataset).get_next()
