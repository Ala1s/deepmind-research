...
import talking_heads_attention
...
class TransformerEncoder(snt.AbstractModule):
  ...
  def __init__(self,
    ...
    self.att = talking_heads_attention.TalkingHeadsAttention(num_heads = self.num_heads, 
                                                              key_dim = self.hidden_size // self.num_heads,
                                                              use_bias = True,
                                                              name='self_attention',dynamic=True)
    ...
    for layer_num in range(self.num_layers):
      with tf.variable_scope('layer_{}'.format(layer_num)):
        ...
        if self.memory_efficient:
          ...
          #     name='self_attention')
          res = self.att(query=res, value=res)
          # num_heads: Number of attention heads.
